    ...
    <div class="col-md-6">
      ...
      >
        <div slot="header" class="clearfix">
          <img height="50px" src="../assets/mtn.png" alt=""/>
          <span class="ml-3"
            style="font-weight: bold;
              font-family: 'Nunito', sans-serif;
              font-size: 20px 1.6; color: #000000;
            "
            >MTN Data Share</span
          >
          <el-button
  ...
  methods: {
    ...
    async topup(topup) {
      ...
      var transaction = {
            ...
            type: "debit",
            service: `Mtn Datashare`,
            description: `MTN ${topup.dataName}  DATA`,
    ...
    onNetworkSelected(event) {
      if (event === "GIFT") {
        this.dataOption = this.$store.state.gift_data;
      }
      if (event === "SME") {
        this.dataOption = this.$store.state.sme_data;
      }
    },
