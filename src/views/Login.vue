      ...
      <v-card translate="yes" class="mx-auto" flat py-6 max-width="430px">
        ...
        <v-card-text>
          <v-form class="mx-4">
            ...
            <v-layout row wrap class="mx-2 py-2">
              <v-text-field
            ...
            <v-layout column class="mx-2 mb-0">
              ...
              ></v-text-field>
              <!-- <v-checkbox
                class="mt-0 black--text subtitle-2"
                v-model="checkbox"
    ...
    loginUser() {
      ...
      firebase
        ...
        .then((data) => {
          ...
          //this.user = data.user;
          let userURL = `users/${data.user.uid}`;
          const ref = firebase.database().ref(userURL);
          ref.once("value", (snapshot) => {
            //console.log("user snap : ", snapshot.val());
            this.user = snapshot.val();
            if (this.user.email === data.user.email) {
              this.$session.start();
